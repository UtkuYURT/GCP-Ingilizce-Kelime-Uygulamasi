...
import com.example.olmazsa_soverim3.ApplicationActivity;
import com.example.olmazsa_soverim3.R;
import com.example.olmazsa_soverim3.databinding.FragmentSigninPageBinding;
...
public class FragmentSigninPage extends Fragment {
    ...
    public void signIn(String txtEmail, String txtSifre) {
        ...
        mAuth.signInWithEmailAndPassword(txtEmail, txtSifre).addOnCompleteListener(getActivity(), new OnCompleteListener<AuthResult>() {
            @Override
            public void onComplete(@NonNull Task<AuthResult> task) {
                if (task.isSuccessful()){
                    ...
                    Log.e("Giriş", "Sign in başarısız: ", task.getException());
